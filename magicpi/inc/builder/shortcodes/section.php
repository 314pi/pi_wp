...
add_ux_builder_shortcode( 'section', array(
	...
	'category'  => __( 'Layout' ),
	'template'  => magicpi_ux_builder_template( 'section.html' ),
	'thumbnail' => magicpi_ux_builder_thumbnail( 'section' ),
	'wrap'      => false,
	'info'      => '{{ label }}',
	'priority'  => -1,
	'styles'    => array(
		'magicpi-banner-effect' => get_template_directory_uri() . '/assets/css/effects.css',
	),
	'presets' => array(
		array(
			'name'      => __( 'Default' ),
			'thumbnail' => magicpi_ux_builder_thumbnail( 'sections/simple-white' ),
			'content'   => '[section]  [/section]',
		),
		array(
			'name'      => __( 'Default Dark' ),
			'thumbnail' => magicpi_ux_builder_thumbnail( 'sections/simple-center' ),
			'content'   => '[section bg_color="rgb(40, 40, 40)" dark="true"]  [/section]',
		),
		array(
			'name'      => __( 'Simple Light' ),
			'thumbnail' => magicpi_ux_builder_thumbnail( 'sections/simple-light' ),
		...
		array(
			'name'      => __( 'Arrow Top' ),
			'thumbnail' => magicpi_ux_builder_thumbnail( 'sections/arrow-down' ),
		...
		array(
			...
			'thumbnail' => magicpi_ux_builder_thumbnail( 'sections/box-right-dark' ),
		...
		array(
			...
			'thumbnail' => magicpi_ux_builder_thumbnail( 'sections/box-left-dark' ),
		...
		array(
			'name'      => __( 'Box Right' ),
			'thumbnail' => magicpi_ux_builder_thumbnail( 'sections/box-right' ),
		...
		array(
			'name'      => __( 'Box Left' ),
			'thumbnail' => magicpi_ux_builder_thumbnail( 'sections/box-left' ),
		...
		array(
			'name'      => __( 'Media Left' ),
			'thumbnail' => magicpi_ux_builder_thumbnail( 'sections/media-left' ),
		...
		array(
			'name'      => __( 'Media Right' ),
			'thumbnail' => magicpi_ux_builder_thumbnail( 'sections/media-right' ),
		...
		array(
			...
			'thumbnail' => magicpi_ux_builder_thumbnail( 'sections/media-left-large' ),
		...
		array(
			...
			'thumbnail' => magicpi_ux_builder_thumbnail( 'sections/media-right-large' ),
		...
		array(
			...
			'thumbnail' => magicpi_ux_builder_thumbnail( 'sections/media-right-large-dark' ),
		...
		array(
			...
			'thumbnail' => magicpi_ux_builder_thumbnail( 'sections/media-left-large-dark' ),
		...
		array(
			...
			'thumbnail' => magicpi_ux_builder_thumbnail( 'sections/media-center' ),
		...
		array(
			'name'      => __( 'Media Top' ),
			'thumbnail' => magicpi_ux_builder_thumbnail( 'sections/media-top' ),
		...
		array(
			...
			'thumbnail' => magicpi_ux_builder_thumbnail( 'sections/media-bottom' ),
