/* global magicpi_gutenberg, wp */
(function () {
  'use strict'

  var MagicpiGutenberg = {
    headerToolbar: null,
    editButton: null,
    init: function () {
      if (!magicpi_gutenberg.edit_button.enabled) {
        return
      }

      this.buttonText = magicpi_gutenberg.edit_button.text
      this.editUrl = magicpi_gutenberg.edit_button.url
