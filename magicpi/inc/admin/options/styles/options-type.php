...
Magicpi_Option::add_section( 'type',
	array(
		'title' => __( 'Typography', 'magicpi-admin' ),
		'panel' => 'style',
	)
);
...
Magicpi_Option::add_field( 'option',
	array(
		...
		'label'    => __( 'Disable Google Fonts. No fonts will be loaded from Google.', 'magicpi-admin' ),
		'section'  => 'type',
		'default'  => 0,
	)
);
...
Magicpi_Option::add_field( 'option',
	array(
		...
		'label'           => __( 'Google Fonts font-display type', 'magicpi-admin' ),
		...
		'default'         => 'swap',
		'choices'         => array(
			'block'    => __( 'Block', 'magicpi-admin' ),
			'swap'     => __( 'Swap', 'magicpi-admin' ),
			'fallback' => __( 'Fallback', 'magicpi-admin' ),
			'optional' => __( 'Optional', 'magicpi-admin' ),
		),
	)
);
...
Magicpi_Option::add_field( 'option',
	array(
		...
		'label'       => esc_attr__( 'Font', 'magicpi-admin' ),
		'section'     => 'type',
		'default'     => array(
			'font-family' => 'Lato',
			'variant'     => '700',
...
Magicpi_Option::add_field( 'option',
	array(
		'type'     => 'typography',
		'settings' => 'type_texts',
		'label'    => esc_attr__( 'Base Text Font', 'magicpi-admin' ),
		'section'  => 'type',
		'default'  => array(
			'font-family' => 'Lato',
			'variant'     => '400',
...
Magicpi_Option::add_field( 'option',
	array(
		'type'        => 'slider',
		'settings'    => 'type_size',
		'label'       => __( 'Base Font Size', 'magicpi-admin' ),
		'section'     => 'type',
...
Magicpi_Option::add_field( 'option',
	array(
		...
		'label'       => __( 'Mobile Base Font Size', 'magicpi-admin' ),
		'section'     => 'type',
...
Magicpi_Option::add_field( 'option',
	array(
		...
		'label'       => esc_attr__( 'Alt font (.alt-font)', 'magicpi-admin' ),
		'section'     => 'type',
		'default'     => array(
...
Magicpi_Option::add_field( 'option',
	array(
		...
		'label'     => esc_attr__( 'Breadcrumbs', 'magicpi-admin' ),
		'section'   => 'type',
		'default'   => '',
		'choices'   => array(
			''     => 'UPPERCASE',
...
Magicpi_Option::add_field( 'option',
	array(
		...
		'label'     => esc_attr__( 'Buttons', 'magicpi-admin' ),
		'section'   => 'type',
		'default'   => '',
		'choices'   => array(
			''     => 'UPPERCASE',
...
Magicpi_Option::add_field( 'option',
	array(
		...
		'label'     => esc_attr__( 'Navigation / Tabs', 'magicpi-admin' ),
		'section'   => 'type',
		'default'   => '',
		'choices'   => array(
			''     => 'UPPERCASE',
...
Magicpi_Option::add_field( 'option',
	array(
		...
		'label'     => esc_attr__( 'Section Titles', 'magicpi-admin' ),
		'section'   => 'type',
		'default'   => '',
		'choices'   => array(
			''     => 'UPPERCASE',
...
Magicpi_Option::add_field( 'option',
	array(
		...
		'label'     => esc_attr__( 'Widget Titles', 'magicpi-admin' ),
		'section'   => 'type',
		'default'   => '',
		'choices'   => array(
			''     => 'UPPERCASE',
