...
<div id="tab-support" class="coltwo-col panel magicpi-panel">
	<div class="cols">
	...
	<div class="inner-panel" style="text-align: center;">
		...
		<h3>How-to Videos</h3>
		<p>Our How-to videos is perfect for learning about Magicpi and what is possible.</p>
        <a href="https://www.youtube.com/channel/UCeccZ4VQ8b5ZoMI-wU6qgFg" target="_blank" class="button button-primary">
        <?php _e( 'Open Videos', 'magicpi-admin' ); ?></a>
	</div>
	...
	<div class="inner-panel" style="text-align: center;">
        ...
        <?php _e( 'Open Documentation', 'magicpi-admin' ); ?></a>
	</div>
	...
	<img style="width:100px; margin:30px 15px 0;" src="<?php echo get_template_directory_uri().'/inc/admin/panel/img/emailsupport.png'; ?>"/>			<h3>Premium E-mail Support</h3>
		<p>All customers of Magicpi has access to premium e-mail support.</p>
		<?php if(!magicpi_is_theme_enabled())	{ ?>
			<a href="<?php echo admin_url().'admin.php?page=magicpi-panel';?>" class="button button-primary">Activate Theme to get support</a>
    	<?php } else if(magicpi_is_support_expired(basename( get_template_directory() ))){ ?>
    		<p><strong>Support has expired :(</strong></p>
    		<a target="_blank" href="//themeforest.net/item/magicpi-responsive-woocommerce-theme/5484319?ref=UX-themes" class="button button-warning" style="color:red;">+ Extend Support time</a>
		<?php } else {
			global $current_user;
			?>
		<a href="mailto:support@uxthemes.com?subject=Need help with Magicpi &body=Enter Your Message here...%0D%0A%0D%0A Best regards,%0D%0A <?php echo $current_user->user_firstname.' '; echo $current_user->user_lastname; ?> %0D%0A %0D%0A%0D%0A[Keep this] Theme license: <?php echo sanitize_text_field( get_option( basename( get_template_directory() ) . '_wup_purchase_code', '' ) );?> [Required for support]" class="button button-primary">
			<?php _e( 'Send us a Support Ticket', 'magicpi-admin' ); ?>
		</a>
	...
	<div class="cols">
		...
		<div class="inner-panel" style="text-align: center;">
			<h3>Magicpi Community</h3>
			<p>Join our community and get help from other Magicpi Users.</p>
		    <a href="//www.facebook.com/groups/magicpi/" class="button button-primary">
	        <?php _e( 'Join Community', 'magicpi-admin' ); ?></a>
		</div>

		<div class="inner-panel" style="text-align: center;">
			<h3>Beta Testing Group</h3>
			<p>Test new versions of Magicpi before everyone else</p>
		    <a href="//www.facebook.com/groups/magicpibeta/" class="button button-primary">
	        <?php _e( 'Join Beta Group', 'magicpi-admin' ); ?></a>
		</div>


    <div class="inner-panel" style="text-align: center;">
      <h3>Feature Requests</h3>
      <p>Send Feature Request for Magicpi Theme and vote for the ones you like.</p>
      <a href="//uxthemes.canny.io/magicpi" class="button button-primary">
      <?php _e( 'Feature Requests', 'magicpi-admin' ); ?></a>
    </div>
