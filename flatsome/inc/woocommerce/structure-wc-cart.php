...
if(!function_exists('magicpi_html_cart_footer')) {
  function magicpi_html_cart_footer(){
  ...
  add_action( 'woocommerce_after_cart', 'magicpi_html_cart_footer', 99);
}


// Add Content in cart sidebar
if(!function_exists('magicpi_html_cart_sidebar')) {
  function magicpi_html_cart_sidebar(){
  ...
  add_action( 'magicpi_cart_sidebar', 'magicpi_html_cart_sidebar', 10);
}


// Continue Shopping button
if(!function_exists('magicpi_continue_shopping')) {
  function magicpi_continue_shopping(){
    wc_get_template_part('cart/continue-shopping');
  }
}
add_action('woocommerce_cart_actions', 'magicpi_continue_shopping', 10);


// Move Privacy policy to bottom
function magicpi_fix_policy_text(){
...
add_action( 'init', 'magicpi_fix_policy_text', 10);
