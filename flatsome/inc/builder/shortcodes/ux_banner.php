...
add_ux_builder_shortcode( 'ux_banner', array(
  ...
  'name' => __( 'Banner' ),
  'category' => __( 'Content' ),
  'thumbnail' => magicpi_ux_builder_thumbnail( 'ux_banner' ),
  'toolbar_thumbnail' => 'bg',
  'template' => magicpi_ux_builder_template( 'ux_banner.html' ),
  'wrap' => false,
  'info' => '{{ label }}',
  ...
  'presets' => array(
    array(
      'name' => __( 'Blank' ),
      'thumbnail' => magicpi_ux_builder_thumbnail( 'banners/blank' ),
    ...
    array(
      ...
      'thumbnail' => magicpi_ux_builder_thumbnail( 'banners/simple-center' ),
    ...
    array(
      'name' => __( 'Left' ),
      'thumbnail' => magicpi_ux_builder_thumbnail( 'banners/simple-left' ),
    ...
    array(
      'name' => __( 'Right' ),
      'thumbnail' => magicpi_ux_builder_thumbnail( 'banners/simple-right' ),
    ...
    array(
      ...
      'thumbnail' => magicpi_ux_builder_thumbnail( 'banners/simple-buttons' ),
    ...
    array(
      ...
      'thumbnail' => magicpi_ux_builder_thumbnail( 'banners/simple-buttons-right' ),
    ...
    array(
      'name' => __( 'Left Light' ),
      'thumbnail' => magicpi_ux_builder_thumbnail( 'banners/simple-left-light' ),
    ...
    array(
      'name' => __( 'Right Light' ),
      'thumbnail' => magicpi_ux_builder_thumbnail( 'banners/simple-right-light' ),
     ...
     array(
      'name' => __( 'Box Left' ),
      'thumbnail' => magicpi_ux_builder_thumbnail( 'banners/box-left' ),
    ...
    array(
      'name' => __( 'Box Right' ),
      'thumbnail' => magicpi_ux_builder_thumbnail( 'banners/box-right' ),
     ...
     array(
      ...
      'thumbnail' => magicpi_ux_builder_thumbnail( 'banners/dark-box-left' ),
     ...
     array(
      ...
      'thumbnail' => magicpi_ux_builder_thumbnail( 'banners/circle-right' ),
     ...
     array(
      'name' => __( 'Huge Sale' ),
      'thumbnail' => magicpi_ux_builder_thumbnail( 'banners/huge-sale' ),
    ...
    array(
      'name' => __( 'Badge' ),
      'thumbnail' => magicpi_ux_builder_thumbnail( 'banners/badge' ),
    ...
    array(
      ...
      'thumbnail' => magicpi_ux_builder_thumbnail( 'banners/badge-bubble' ),
    ...
    array(
      ...
      'thumbnail' => magicpi_ux_builder_thumbnail( 'banners/badge-simple' ),
