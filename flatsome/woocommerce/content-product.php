...
<div <?php fl_woocommerce_version_check( '3.4.0' ) ? wc_product_class( $classes, $product ) : post_class( $classes ); ?>>
	...
	<div class="product-small box <?php echo magicpi_product_box_class(); ?>">
		<div class="box-image">
			<div class="<?php echo magicpi_product_box_image_class(); ?>">
				<a href="<?php echo get_the_permalink(); ?>">
					<?php
						 ...
						 */
						do_action( 'magicpi_woocommerce_shop_loop_images' );
					?>
				</a>
			</div>
			...
			<div class="image-tools is-small hide-for-small bottom left show-on-hover">
				<?php do_action( 'magicpi_product_box_tools_bottom' ); ?>
			</div>
		...
		<div class="box-text <?php echo magicpi_product_box_text_class(); ?>">
			<?php
