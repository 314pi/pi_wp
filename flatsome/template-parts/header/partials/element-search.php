...
<li class="header-search header-search-dropdown has-icon has-dropdown menu-item-has-children">
	...
	<a href="#" aria-label="<?php echo __('Search','woocommerce'); ?>" class="<?php echo get_magicpi_icon_class(magicpi_option('search_icon_style'), 'small'); ?>"><?php echo get_magicpi_icon('icon-search'); ?></a>
...
<li class="header-search header-search-lightbox has-icon">
	<?php if($icon_style) { ?><div class="header-button"><?php } ?>
		...
		class="<?php echo get_magicpi_icon_class(get_theme_mod('search_icon_style'), 'small'); ?>">
		<?php echo get_magicpi_icon('icon-search', '16px'); ?></a>
