<li class="header-contact-wrapper">
	<?php
		...
		if(magicpi_option('contact_style') == 'top'){
			$class .= ' icon-top';
		}
	?>
	...
	<div class="header-button"><a href="#"
		...
		class="icon show-for-medium"><?php echo get_magicpi_icon('icon-envelop',$icon_size); ?></a>
	</div>
		...
		<?php if(magicpi_option('contact_location')){ ?>
			<li class="<?php echo $class; ?>">
			  <a target="_blank" rel="noopener noreferrer" href="https://maps.google.com/?q=<?php echo magicpi_option('contact_location'); ?>" title="<?php echo magicpi_option('contact_location'); ?>" class="<?php echo $class_link;?>">
			     ...
			     <?php if($label) _e('Location','magicpi'); ?>
			  </a>
			</li>
			<?php } ?>

			<?php if(magicpi_option('contact_email')){ ?>
			<li class="<?php echo $class; ?>">
			  <a href="mailto:<?php echo magicpi_option('contact_email'); ?>" class="<?php echo $class_link;?>" title="<?php echo magicpi_option('contact_email'); ?>">
				  <?php echo get_magicpi_icon('icon-envelop',$icon_size); ?>
			      <?php if($label) _e('Contact','magicpi'); ?>
			  </a>
			</li>
			<?php } ?>

			<?php if(magicpi_option('contact_hours')){ ?>
			<li class="<?php echo $class; ?>">
			  <a class="<?php echo $class_link;?>" title="<?php echo magicpi_option('contact_hours').' | '.magicpi_option('contact_hours_details'); ?>">
			  	   <?php echo get_magicpi_icon('icon-clock',$icon_size); ?>
			       <?php if($label) echo magicpi_option('contact_hours'); ?>
			  </a>
			 </li>
			<?php } ?>
			...
			<li class="<?php echo $class; ?>">
			  <a href="tel:<?php echo magicpi_option('contact_phone'); ?>" class="<?php echo $class_link;?>" title="<?php echo magicpi_option('contact_phone'); ?>">
			     ...
			     <?php if($label) echo magicpi_option('contact_phone'); ?>
			  </a>
			</li>
			<?php } ?>
	</ul>
